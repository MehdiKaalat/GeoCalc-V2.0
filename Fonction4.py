...
"")
    ...
    def calculer(self):
     try:
        ...
        #u0 = U(a, b, phi_0)
        u0 = math.log(math.tan(math.pi / 4 + phi_0 / 2)) - (e2 / 2) * math.log((1 + math.sqrt(e2) * math.sin(phi_0)) / (1 - sqrt(e2) * math.sin(phi_0)))
        N0=a/sqrt(1-e2*sin(phi_0)**2)
        e0 = K0 * N0 / tan(phi_0)

        # longitude Lambda
        L_c = (1 / (sin(phi_0))) * (atan(X / (e0 - Y)))
        L = (L_c + L0)*(180/pi)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_17.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">Transformatoin des coord. de projection Lambert en</p><p align=\"center\">coord. géographiques</p></body></html>"))
